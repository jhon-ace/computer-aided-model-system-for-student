            ...
            <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                        <td  class="text-black border border-gray-400 px-4 py-2"><input type="checkbox" name="selected[]" value="<?php echo e($department->id); ?>"></td>
                            <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($department->department_name); ?></td>
                            <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($department->department_description); ?></td>
                            <td class="text-black border border-gray-400 px-4 py-2">
                                <div class="flex justify-center items-center space-x-2">
                                    <a href="<?php echo e(route('admin.department.edit', $department->id)); ?>" class="bg-blue-500 text-white text-sm px-3 py-2 rounded hover:bg-red-500">
