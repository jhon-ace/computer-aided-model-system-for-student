...
<?php endif; ?>
    ...
    <div class="overflow-x-auto">
        <!--[if BLOCK]><![endif]--><?php if($faculties->isEmpty()): ?>
            <p class="text-black mt-10 text-center">No faculty found for matching "<?php echo e($search); ?>"</p>
        <?php else: ?>
                <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-400 px-4 py-2">
                                <button wire:click="sortBy('faculty_photo')" class="w-full h-full flex items-center justify-center">
                                    Photo
                                    <!--[if BLOCK]><![endif]--><?php if($sortField == 'faculty_photo'): ?>
                            ...
                            <th class="border border-gray-400 px-4 py-2">
                                <button wire:click="sortBy('faculty_name')" class="w-full h-full flex items-center justify-center">
                                    Faculty Name
                                    <!--[if BLOCK]><![endif]--><?php if($sortField == 'faculty_name'): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($sortDirection == 'asc'): ?>
                                            &nbsp;<i class="fa-solid fa-down-long fa-xs"></i>
                                            <?php else: ?>
                                            &nbsp;<i class="fa-solid fa-up-long fa-xs"></i> 
                    ...
                    <form id="deleteSelectedForm" action="<?php echo e(route('admin.faculty.deleteSelected')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete the selected faculty?');">
                        <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-black border border-gray-400 px-4 py-2"><input type="checkbox" name="selected[]" value="<?php echo e($faculty->id); ?>"></td>
                                    <td class="text-black border border-gray-400 px-4 py-2 flex  items-center justify-center">
                                        <!--[if BLOCK]><![endif]--><?php if($faculty->faculty_photo): ?>
                                            <img src="<?php echo e(asset('storage/faculty_photos/' . $faculty->faculty_photo)); ?>" class="rounded-full w-9 h-9">
                                        <?php else: ?>
                                            <img id="imagePreview" src="<?php echo e(asset('assets/img/user.png')); ?>" class="rounded-lg w-9 h-9">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </td>

                                    <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($faculty->faculty_fullname); ?></td>
                                    <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($faculty->email); ?></td>
                                    <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($faculty->department->department_name); ?></td>
                                    <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($faculty->status); ?></td>
                                    <td class="text-black border border-gray-400 px-4 py-2">
                                        <div class="flex justify-center items-center space-x-2">
                                            <a href="<?php echo e(route('admin.faculty.edit', $faculty->id)); ?>" class="bg-blue-500 text-white text-sm px-3 py-2 rounded hover:bg-red-500">
...
<?php /**PATH C:\Users\Jhon Ace\Desktop\guide\resources\views/livewire/faculty-show-table.blade.php ENDPATH**/ ?>