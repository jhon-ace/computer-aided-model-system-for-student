...
<?php endif; ?>
    ...
    <div class="overflow-x-auto">
        <!--[if BLOCK]><![endif]--><?php if($deans->isEmpty()): ?>
        ...
        <?php else: ?>
            <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                    ...
                    <tr>
                        ...
                        <th class="border border-gray-400 px-4 py-2">
                            <button wire:click="sortBy('dean_fullname')" class="w-full h-full flex items-center justify-center">
                                Dean Full Name
                                <!--[if BLOCK]><![endif]--><?php if($sortField == 'dean_fullname'): ?>
                        ...
                        <th class="border border-gray-400 px-4 py-2">
                            <button wire:click="sortBy('dean_status')" class="w-full h-full flex items-center justify-center">
                                Dean Status
                                <!--[if BLOCK]><![endif]--><?php if($sortField == 'dean_status'): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($sortDirection == 'asc'): ?>
                                        &nbsp;<i class="fa-solid fa-down-long fa-xs"></i>
                                        <?php else: ?>
                                        &nbsp;<i class="fa-solid fa-up-long fa-xs"></i> 
                ...
                <form id="deleteSelectedForm" action="<?php echo e(route('admin.dean.deleteSelected')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete the selected deans?');">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <input type="hidden" wire:model="deleteAllClicked" value="true">
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $deans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dean): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
...
<?php /**PATH C:\Users\Jhon Ace\Desktop\guide\resources\views/livewire/dean-show-table.blade.php ENDPATH**/ ?>