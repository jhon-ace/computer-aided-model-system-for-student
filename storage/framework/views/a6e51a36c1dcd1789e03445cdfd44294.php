                ...
                <div class="text-gray-700 ml-5 text-md">Admin / Edit Course</div>
                    <div class="container mx-auto p-4">
                        <div class="bg-white shadow-lg rounded-md p-5 sm:p-6 md:p-8 lg:p-10 text-black font-medium">
                            ...
                            <form action="<?php echo e(route('admin.faculty.update', $faculty->id)); ?>" method="POST" class="" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <label for="faculty_photo" class="cursor-pointer flex flex-col items-center">
                                        <div id="imagePreviewContainer" class="mb-2 text-center">
                                            <img id="imagePreview" src="<?php echo e($faculty->faculty_photo ? asset('storage/faculty_photos/' . $faculty->faculty_photo) : asset('assets/img/user.png')); ?>" class="rounded-lg w-48 h-auto" >
...
<?php endif; ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="faculty_fullname" id="faculty_fullname" value="<?php echo e(old('faculty_fullname', $faculty->faculty_fullname)); ?>"  class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline <?php $__errorArgs = ['dean_fullname'];
...
<?php endif; ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" name="email" id="email" value="<?php echo e(old('email', $faculty->email)); ?>"  class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline <?php $__errorArgs = ['dean_fullname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        <input type="password" name="password" id="password" value="<?php echo e(old('password', $faculty->password)); ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline <?php $__errorArgs = ['faculty_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="status" name="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required >
                                        <?php if($faculty->status === 'Active'): ?>
                                            <option value="<?php echo e($faculty->status); ?>" selected><?php echo e($faculty->status); ?></option>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php if($faculty->department->department_name): ?>
                                            <option value="<?php echo e($faculty->department->id); ?>" selected><?php echo e($faculty->department->department_name); ?></option>
                                        <?php else: ?>    
...
<?php endif; ?>
                                    <small class="mt-2">
                                        <span class="text-red-500">Note:</span> The department where the faculty <?php echo e($faculty->faculty_fullname); ?> is assigned can't be changed.
                                    </small>
                                </div>
...
<?php /**PATH C:\Users\Jhon Ace\Desktop\guide\resources\views/admin/faculty/edit.blade.php ENDPATH**/ ?>