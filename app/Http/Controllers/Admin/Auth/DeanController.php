   ...
   // return redirect()->route('dean.index')->with('success', $dean->dean_fullname . ' Dean updated successfully.');
    ...
    public function deleteSelected(Request $request)
    {
        ...
        if ($selectedDeans) {
            ...
            return redirect()->route('admin.dean.index')->with('success', 'Selected deans have been deleted successfully.');
        } else {
            return redirect()->route('admin.dean.index')->with('error', 'No deans selected for deletion.');
        }
    }
}
