...
class FacultyController extends Controller
{
    ...
    public function deleteSelected(Request $request)
    {
        ...
        if ($selectedFaculties) {
            ...
            return redirect()->route('admin.faculty.index')->with('success', 'Selected faculty have been deleted successfully.');
        } else {
            // Redirect with an error message if no courses were selected
            return redirect()->route('admin.faculty.index')->with('error', 'No faculty selected for deletion.');
        }
    }
}
