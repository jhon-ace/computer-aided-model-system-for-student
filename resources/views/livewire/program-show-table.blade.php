    ...
    <div class="overflow-x-auto">
        ...
        @else
            <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                ...
                <form id="deleteSelectedForm" action="{{ route('admin.program.deleteSelected') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete the selected program?');">
                        @csrf
                        @method('DELETE')
