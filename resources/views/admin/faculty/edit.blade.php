<x-admin-app-layout>
<x-user-route-page-name :routeName="'admin.faculty.edit'" />
                    ...
                    <div class="container mx-auto p-4">
                        <div class="bg-white shadow-lg rounded-md p-5 sm:p-6 md:p-8 lg:p-10 text-black font-medium">
                            <div class="flex justify-end mb-4">
                                <a href="{{ route('admin.faculty.index') }}"><button class="bg-blue-500 text-white px-4 py-2 rounded-md"><i class="fa-solid fa-arrow-left" style="color: #ffffff;"></i> Back to list</button></a>
                            </div>
                            <form action="{{ route('admin.faculty.update', $faculty->id) }}" method="POST" class="" enctype="multipart/form-data">
